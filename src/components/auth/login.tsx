    ...
    return (
        <div className="flex relative w-screen h-screen">
            ...
            <div className="flex flex-col items-center justify-center ">
                ...
                <button className="bg-light-gray flex justify-center gap-2 w-96 py-3 rounded-lg"><img src="/public/google.svg" />Google</button>
            </div>
            </div>
            ...
            <div className=" p-8 flex flex-col justify-center items-center item2 bg-pastel-pink">
                 <div className="flex flex-col mb-10">
                    ...
                    <p className="poetsen-one-regular text-xl">New here? Sign up now and start your journey to find your life partner. With our easy-to-use platform, you'll connect with like-minded individuals who share your interests and values. Don't wait—your perfect match could be just a click away! Join us today and discover the love of your life.</p>
                </div>

                <a href="#" className="  px-7 py-2 font-semibold rounded-lg tracking-wider bg-pink text-white hover:text-pastel-pink">sign up</a>
            </div>
        </div>
    )
}