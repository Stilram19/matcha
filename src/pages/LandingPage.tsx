...
const LandingPage = () => {
    ...
    return (
        <div className="w-screen h-screen">
            ...
            <div className="w-full h-full flex justify-center relative bg-black bg-opacity-40">
                <div className="w-1/2 flex flex-col items-start justify-center">
                    <h1 className="text-7xl lg:text-9xl text-deep-plum">Meet</h1>
                    <h2 className="poetsen-one-regular text-2xl lg:text-6xl text-white">Your Perfect Match with Matcha!</h2>
                    <div className="text-white text-md lg:text-xl my-5">
